...
namespace SalesTrack.API.Data
{
    public class SalesTrackDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            #region Sale Entity Configuration
            modelBuilder.Entity<Sale>()
                .Property(s => s.Amount)
                .HasColumnType("decimal(18,2)");

            modelBuilder.Entity<Sale>()
                .HasCheckConstraint("CK_Sales_Quantity", "[Quantity] > 0");

            modelBuilder.Entity<Sale>()
                .HasCheckConstraint("CK_Sales_Amount", "[Amount] >= 0");
            ...
            modelBuilder.Entity<Sale>().HasData(
                new Sale
                {
                    ...
                    Amount = 350000m,
                    UserId = 1,
                    SaleDate = new DateTime(2025, 8, 10)
                },
                new Sale
                {
                    SaleId = 2,
                    ...
                    Amount = 500000m,
                    UserId = 2,
                    SaleDate = new DateTime(2025, 8, 11)
                }
            );
            #endregion
        }
